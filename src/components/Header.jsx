const lightIcon = (
  <svg
    className="fill-white group-hover:fill-greyblue transition-all duration-300"
    width="20"
    height="20"
...
const darkIcon = (
  <svg
    className="fill-lightgrey3 group-hover:fill-darkgrey1 transition-all duration-300"
    width="20"
    height="20"
    xmlns="http://www.w3.org/2000/svg"
  >
